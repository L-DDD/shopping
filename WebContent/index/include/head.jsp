		...
		<%if (user!=null){ %>
			...
			<li>
				...
				<ul class="dropdown-menu pull-right">
					<li><a tabindex="-1" href="${pageContext.request.contextPath}/index/order.jsp"><i class="fa fa-history"></i>订单历史</a></li>
					<li class="divider"></li>
					<li><a tabindex="-1" href="${pageContext.request.contextPath}/index/wishlist.jsp"><i class="fa fa-bookmark"></i>收藏夹</a></li>
					<li><a tabindex="-1" href="${pageContext.request.contextPath}/index/contact.jsp"><i class="fa fa-edit"></i>常用联系人</a></li>
